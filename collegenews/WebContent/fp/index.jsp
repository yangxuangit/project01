...
<body>
     <div class="row nav-justified">
			...
			<div id="myCarousel" class="carousel slide">
				...
				<div class="carousel-inner">
					<div class="item active">
						<img class="lunbotu" src="fp/img/20171102.jpg" alt="First slide">
					</div>
					<div class="item">
						<img class="lunbotu" src="fp/img/2018062002.jpg" alt="Second slide">
					</div>
					<div class="item">
						<img class="lunbotu" src="fp/img/2018072801.jpg" alt="Third slide">
					</div>
				</div>
				<!-- 轮播（Carousel）导航 -->
		...
		<ul class="pagination" >
			...
			<li><a href="news?method=findMynews&cp=${pu.next}"><span>&raquo;</span></a></li>
		</ul>													
			</div> 
		</div>
	</div>
